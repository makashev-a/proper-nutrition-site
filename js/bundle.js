...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    function currentSlide(slidesLength, slideIndex, currentElem) {
        if (slidesLength < 10) {
    ...
    function activeDot(dots, slideIndex) {
    ...
    next.addEventListener('click', () => {
        ...
        currentSlide(slides.length, slideIndex, current);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-04-21');
